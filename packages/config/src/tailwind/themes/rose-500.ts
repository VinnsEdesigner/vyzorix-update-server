// @vyzorix/config/tailwind/themes/rose-500.ts - Rose-500 Primary Theme
// Rose-500 is the most important brand color for Vyzorix

export const rose500Theme = {
  name: "rose-500",
  colors: {
    // Rose-500 Primary (MOST IMPORTANT BRAND COLOR)
    primary: {
      DEFAULT: "oklch(0.65 0.22 16.439)", // Rose-500 base
      ...
      500: "oklch(0.65 0.22 16.439)", // Main brand color
    ...
    // Accent colors (Teal/Cyan to complement Rose)
    accentColors: {
    ...
    destructive: {
      ...
      foreground: "oklch(0.984 0.003 247.858)",
      50: "oklch(0.75 0.20 27.325)",
      100: "oklch(0.70 0.22 27.325)",
      200: "oklch(0.65 0.235 27.325)",
      300: "oklch(0.62 0.24 27.325)",
      400: "oklch(0.60 0.245 27.325)",
      500: "oklch(0.577 0.245 27.325)",
      600: "oklch(0.52 0.22 27.325)",
      700: "oklch(0.45 0.19 27.325)",
      800: "oklch(0.38 0.16 27.325)",
      900: "oklch(0.30 0.12 27.325)",
    },
    ...
    // Chart colors (Rose-based palette)
    chart: {
      1: "oklch(0.65 0.22 16.439)",   // Rose-500
      2: "oklch(0.60 0.18 180.0)",    // Rose-400
      3: "oklch(0.55 0.15 340.0)",    // Rose-600
      4: "oklch(0.70 0.16 200.0)",    // Teal accent
      5: "oklch(0.75 0.14 160.0)",    // Cyan accent
    },
...
// Dark mode overrides for Rose-500 theme
export const rose500DarkTheme = {
  colors: {
    ...
    primary: "oklch(0.65 0.22 16.439)", // Rose-500 stays the same
    "primary-foreground": "oklch(0.985 0 0)",
    ...
    ring: "oklch(0.65 0.22 16.439)", // Rose-500 ring
    chart: {
      1: "oklch(0.65 0.22 16.439)",   // Rose-500
      2: "oklch(0.60 0.18 180.0)",    // Rose-400
      3: "oklch(0.55 0.15 340.0)",    // Rose-600
