// @vyzorix/config/tailwind/themes/default.ts - Default Light/Dark Theme
// Uses rose-500 as the primary brand color
...
export const defaultTheme = {
  ...
  colors: {
    ...
    primary: {
      DEFAULT: "oklch(0.65 0.22 16.439)", // Rose-500
...
export const defaultDarkTheme = {
  colors: {
    ...
    chart: {
      ...
      5: "oklch(0.65 0.22 16.439)", // Rose-500
    },
    sidebar: {
...
export default { ...defaultTheme, darkMode: defaultDarkTheme };