...
echo "  Status: ⚠️  Using OLD imports"
echo ""
...
echo "│ Admin handlers                                 │ ⚠️  Still OLD (admin*.go)            │"
echo "│ OAuth handlers                                 │ ⚠️  Still OLD (auth_oauth.go)         │"
echo "│ MFA handlers                                  │ ⚠️  Still OLD (auth_mfa.go)          │"
echo "│ WebSocket handler                              │ ⚠️  Still OLD (websocket_handler.go) │"
echo "└────────────────────────────────────────────────┴────────────────────────────────────────┘"
...
echo "  OLD Flat Handlers: ⚠️  Still using pkg/models, pkg/storage"
echo ""
...
echo "    - Flat handlers: ⚠️  Pending migration"
echo ""
echo "═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"
