...
echo "│ OLD pkg/ (TO BE PHASED)                          │ ⚠️  $(find pkg -name "*.go" -type f 2>/dev/null | grep -v "_test" | wc -l) files                          │"
echo "│ OLD internal/ (TO BE PHASED)                     │ ⚠️  $(find internal/audit internal/auth internal/fcm internal/metrics internal/ssr internal/*.go -name "*.go" -type f 2>/dev/null | grep -v "_test" | wc -l) files                         │"
echo "└────────────────────────────────────────────────┴────────────────────────────────────────────────┘"
