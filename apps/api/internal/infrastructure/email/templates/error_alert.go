...
// ErrorAlertEmail is the HTML template for error alert notifications.
const ErrorAlertEmail = `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .alert-box { background: #f8d7da; border: 1px solid #f5c6cb; border-radius: 8px; padding: 20px; margin: 24px 0; }
        ...
        .error-message { background: #721c24; color: #f8d7da; padding: 12px; border-radius: 4px; margin-top: 12px; font-family: monospace; word-break: break-all; }
